...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Configuración del DrawerLayout (menú deslizante)
        drawerLayout = findViewById(R.id.drawer_layout);
        ActionBarDrawerToggle toggle = new ActionBarDrawerToggle(this, drawerLayout, toolbar, R.string.navigation_drawer_open, R.string.navigation_drawer_close);
        drawerLayout.addDrawerListener(toggle);
        toggle.syncState();

        // Configuración del NavigationView (menú de navegación)
    ...
    private int getTitle(@NonNull MenuItem menuItem) {
        ...
        switch (nombre) {
            ...
            default:
                throw new IllegalArgumentException("pendiente para el desarrollador");
        }
    }
